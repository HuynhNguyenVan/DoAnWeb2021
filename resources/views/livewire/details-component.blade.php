                    ...
                    <div class="detail-info">
                        ...
                        @if ($product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now() )
                            <div class="wrap-price">
                                ...
                                <del><span class="product-price regprice">${{ $product->regu_price }}</span></del>
                            </div>
                        @else
                            <div class="wrap-price"><span class="product-price">${{ $product->regu_price }}</span></div>
                        @endif
                        <div class="stock-info in-stock">
                            <p class="availability">Availability: <b>{{ $product->stock_stutus }}</b></p>
                        </div>
                        <div class="quantity">
                            <span>Quantity:</span>
                        ...
                        <div class="wrap-butons">
                            ...
                            @else
                                <a href="#" class="btn add-to-cart" wire:click.prevent="store({{ $product->id }},'{{ $product->name }}',{{ $product->regu_price }})">Add to Cart</a>
                            @endif
                            <div class="wrap-btn">
                                ...
                                <li class="product-item">
                                    <div class="product product-widget-style">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><span class="product-price">${{ $p_product->regu_price }}</span></div>
                                        </div>
                                    </div>
                                </li>
                            @endforeach
                            ...
                            @foreach ($related_products as $r_product)
                                <div class="product product-style-2 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span class="product-price">${{ $r_product->regu_price }}</span></div>
                                    </div>
                                </div>
                            @endforeach
                        </div>
