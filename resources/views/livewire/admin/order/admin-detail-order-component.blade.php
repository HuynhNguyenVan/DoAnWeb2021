            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">Order Item</div>
                            <div class="col-md-6">
                                <a href="{{ route('admin.order') }}" class="btn btn-success pull-right">All Order</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="products-cart">
                                @foreach ($order->orderItems as $item)
                                    <li class="pr-cart-item">
                                        ...
                                        <div class="price-field sub-total"><p class="price">${{ $item->price * $item->qty }}</p></div>
                                    </li>
                                @endforeach											
                            </ul>
                        </div>
