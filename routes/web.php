...
use App\Http\Livewire\Admin\Order\AdminDetailOrderComponent;
...
Route::middleware(['auth:sanctum', 'verified'])->group(function(){
    ...
    Route::get('/user/order/{order_id}',UserOrderDetailComponent::class)->name('user.order.detail');
});

Route::middleware(['auth:sanctum', 'verified','authadmin'])->group(function(){
    Route::get('/admin',AdminLoginComponent::class);
    ...
    Route::get('/admin/order/{order_id}',AdminDetailOrderComponent::class)->name('admin.order.detail');
});